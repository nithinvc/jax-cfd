...
#         def forcing_func(grid): return cfd.forcings.kolmogorov_forcing(  # noqa: E731
#             grid,
...
#         def forcing_func(grid): return cfd.forcings.transient_flow_forcing(  # noqa: E731
...
#     save_dt = stable_dt  # args.save_dt
...
#         )
#     )
#     jax.debug.print("Test debug print: {}", 42)

#     def test_callback(field, name, step):
#         os.makedirs("test_dir", exist_ok=True)
#         np.save(f"test_dir/{name}_{step}.npy", np.array(field))
#         print(f"Saved {name}_{step}")

#     field = jnp.array([[1.0, 2.0], [3.0, 4.0]])
#     jax.debug.callback(test_callback, field, "test_field", 0)
#     os.makedirs("/data/divyam123/meta-cfd/jaxcfd_fields/test", exist_ok=True)
#     np.save("/data/divyam123/meta-cfd/jaxcfd_fields/test/test.npy",
#             np.array([1, 2, 3]))
